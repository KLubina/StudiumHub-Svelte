/* ==== HSLU EIT THIRD YEAR LAYOUT ==== */
/* Spezifisches Layout für das 5./6. Semester - Kategorie-basiert */

if (window.HSLUEITSpecificprogram) {
  /* ==== 3. JAHR LAYOUT - KATEGORIE-BASIERT ==== */
  window.HSLUEITSpecificprogram.prototype.createYearSection = function (year) {
    if (year === 3) {
  ...
  window.HSLUEITSpecificprogram.prototype.createThirdYearSection = function () {
  ...
  window.HSLUEITSpecificprogram.prototype.createCategoryBasedThirdYear =
    function (container) {
