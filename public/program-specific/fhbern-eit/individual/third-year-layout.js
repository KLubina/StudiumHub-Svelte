...
if (window.BFHEITSpecificprogram) {
  ...
  window.BFHEITSpecificprogram.prototype.createYearSection = function (year) {
    if (year === 3) {
  ...
  window.BFHEITSpecificprogram.prototype.createThirdYearSection = function () {
  ...
  window.BFHEITSpecificprogram.prototype.createCategoryBasedThirdYear =
    function (container) {
