...
window.StudiengangCustomClass = class MSCITETSpecificprogram extends (
  SpecificprogramBase
) {
  constructor(config) {
    super(config);
  ...
  combineWahlmoduleData() {
    ...
    // Kernfächer
    if (
      window.MSCITETKernfaecherData &&
      window.MSCITETKernfaecherData.kernfaecherSchwerpunkte
    ) {
      combinedData.kernfaecherSchwerpunkte =
        window.MSCITETKernfaecherData.kernfaecherSchwerpunkte;
    }
    ...
    if (
      ...
      window.MSCITETVertiefungsfaecherData.vertiefungsfaecherBereiche
    ) {
      combinedData.vertiefungsfaecherBereiche =
        window.MSCITETVertiefungsfaecherData.vertiefungsfaecherBereiche;
    }
