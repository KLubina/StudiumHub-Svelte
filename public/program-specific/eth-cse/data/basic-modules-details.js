...
window.StudiengangModuleDetails = {
  ...
  "Analysis III": {
    kurzbeschreibung:
      "In this lecture we treat problems in applied analysis. The focus lies on the solution of quasilinear first order PDEs with the method of characteristics, and on the study of three fundamental types of partial differential equations of second order.",
    inhalt:
  ...
  "Physik I": {
    kurzbeschreibung:
      "Einführung in die Denk- und Arbeitsweise in der Physik unter Zuhilfenahme von Demonstrationsexperimenten.",
    inhalt:
      "Mechanik:\n" +
      "• Bewegung\n" +
      "• Newtonsche Axiome\n" +
  ...
  Chemie: {
    kurzbeschreibung:
      "Einführung in die Chemie mit Aspekten aus der anorganischen, organischen und physikalischen Chemie.",
    inhalt:
  ...
  Informatik: {
    kurzbeschreibung:
      "Die Vorlesung bietet eine Einführung in das Programmieren mit einem Fokus auf systematischem algorithmischem Problemlösen. Lehrsprache ist C++.",
    inhalt:
      "Einführung:\n" +
  ...
  "Diskrete Mathematik": {
    kurzbeschreibung:
      "Ziel ist die Einführung in die wichtigsten Grundbegriffe der diskreten Mathematik, das Verständnis der Rolle von Abstraktion und Beweisen sowie die Auseinandersetzung mit Anwendungen, etwa aus der Kryptographie, Codierungstheorie und Algorithmentheorie.",
    inhalt:
  ...
  "Programmiertechniken für physikalische Simulationen": {
    ...
    vorlesungslink:
      "https://video.ethz.ch/lectures/d-phys/2012/autumn/402-0811-00L/3c96dea3-c234-4551-9770-9b6390661ebe.html",
  ...
  Bachelorarbeit: {
    kurzbeschreibung:
      "Selbständige Bearbeitung eines wissenschaftlichen Themas",
    inhalt:
  ...
  "Image Analysis and Computer Vision": {
    kurzbeschreibung:
      "Comprehensive introduction to computer vision and image analysis techniques",
    inhalt:
  ...
  "Information Systems for Engineers": {
    kurzbeschreibung:
      "Introduction to information systems design and management for engineering applications",
    inhalt:
  ...
  "Communication Networks": {
    kurzbeschreibung:
      "Fundamentals of computer networks and communication protocols",
    inhalt:
