...
if (window.HSLUEITSpecificprogram) {
  window.HSLUEITSpecificprogram.prototype.combineModuleData = function () {
    ...
    if (
      window.HSLUEITVertiefungsrichtungenData &&
      window.HSLUEITVertiefungsrichtungenData.vertiefungsrichtungen
    ) {
      window.HSLUEITModuleData.vertiefungsrichtungen =
        window.HSLUEITVertiefungsrichtungenData.vertiefungsrichtungen;
    }

    // Erweiterungsmodule
    if (
      window.HSLUEITWahlmoduleData &&
      window.HSLUEITWahlmoduleData.erweiterungsmoduleBereiche
    ) {
      window.HSLUEITModuleData.erweiterungsmoduleBereiche =
        window.HSLUEITWahlmoduleData.erweiterungsmoduleBereiche;
    }
    ...
    if (
      window.HSLUEITWahlmoduleData &&
      window.HSLUEITWahlmoduleData.zusatzmoduleBereiche
    ) {
      window.HSLUEITModuleData.zusatzmoduleBereiche =
        window.HSLUEITWahlmoduleData.zusatzmoduleBereiche;
    }
