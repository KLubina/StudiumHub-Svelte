...
if (window.BFHEITSpecificprogram) {
  window.BFHEITSpecificprogram.prototype.combineModuleData = function () {
    ...
    if (
      window.BFHEITVertiefungsrichtungenData &&
      window.BFHEITVertiefungsrichtungenData.vertiefungsrichtungen
    ) {
      window.BFHEITModuleData.vertiefungsrichtungen =
        window.BFHEITVertiefungsrichtungenData.vertiefungsrichtungen;
    }

    // Wahlmodule
    if (
      window.BFHEITWahlmoduleData &&
      window.BFHEITWahlmoduleData.wahlmoduleBereiche
    ) {
      window.BFHEITModuleData.wahlmoduleBereiche =
        window.BFHEITWahlmoduleData.wahlmoduleBereiche;
    }
